...
# Group Members:
# Siyang Yin - sy2820@columbie.edu
# Ruilong Tang - rt2701@columbia.edu
# Zirui Tan - zt2219@columbia.edu
...
# Account Information
to1 = 'sy2820@columbia.edu' # Email to send to.
to2 = 'rt2701@columbia.edu'
to3 = 'zt2219@columbia.edu'
gmail_user = 'abcd.iot.123@gmail.com' # Email to send from. (MUST BE GMAIL)
