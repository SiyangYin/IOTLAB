...
#########################
# Header info for mailer. Emails ip address at hardcoded emails. 
# Modified to include our emails.
...
# Account Information
to1 = 'srb2208@columbia.edu' # Email to send to.
to2 = 'am4036@columbia.edu'
to3 = 'djs2240@columbia.edu'
gmail_user = 'abcd.iot.columbia@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'abcdabcd!' # Gmail password.
...
msg['To'] = to1 + to2 + to3
# Sends the message
smtpserver.sendmail(gmail_user, [to1, to2, to3], msg.as_string())
